...
export function getConfigFile(areaCode, entityType) {
  return http({
    method: 'get',
    url: 'cosmetic/sub/import/config/' + entityType + '/' + areaCode
  });
}
...
export function getSubordinate(areaCode, entityType) {
  return http({
    method: 'get',
    url: 'cosmetic/sub/import/subordinate/' + entityType + '/' + areaCode
  });
}
...
export function getInfo(entityId) {
  return http({
    method: 'get',
    url: 'cosmetic/sub/import/info/' + entityId
  });
}
...
export function add(importInformaion) {
  ...
  export function page(page, searchMap) {
    return http({
      method: 'post',
      url: 'cosmetic/sub/import/page/' + page.pageNum + '/' + page.pageSize,
      data: searchMap
    });
  }
  ...
  export function review(ids) {
    return http({
      method: 'post',
      url: 'cosmetic/sub/import/review',
      data: ids
    });
  }
...
export function relation(fileId, entityType) {
  return http({
    method: 'get',
    url: 'cosmetic/sub/import/relation/' + entityType + '/' + fileId
  });
}
