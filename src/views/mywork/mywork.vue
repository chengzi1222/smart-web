  ...
  <div class="user-box">
    ...
    <div class="main-body no-star">
      <div class="form-item">主体类型:
        <router-link :to="{name: 'mywork.cfda', query:{pathName: '操作记录'}}" class="router-btn" active-class="active" v-auth="'food.biz.cfda|func.add,food.biz.cfda|func.change,food.biz.cfda|func.edit,food.biz.cfda|func.cancel,food.biz.cfda|func.delay'">
          <el-button>三小管理</el-button>
        </router-link>
        <router-link :to="{name: 'mywork.sub', params: {entityType: 'product'}, query:{pathName: '操作记录'}}" class="router-btn" active-class="active"
          v-auth="'food.biz.pb|func.add,food.biz.pb|func.change,food.biz.pb|func.cancel,food.biz.pb|func.delay'">
          <el-button>生产主体管理</el-button>
        </router-link>
        <router-link :to="{name: 'mywork.sub', params: {entityType: 'circulation'}, query:{pathName: '操作记录'}}" class="router-btn"
          active-class="active" v-auth="'food.biz.cb|func.add,food.biz.cb|func.change,food.biz.cb|func.cancel,food.biz.cb|func.delay'">
          <el-button>流通主体管理</el-button>
        </router-link>
        <router-link :to="{name: 'mywork.sub', params: {entityType: 'restaurant'}, query:{pathName: '操作记录'}}" class="router-btn"
          active-class="active" v-auth="'food.biz.rb|func.add,food.biz.rb|func.change,food.biz.rb|func.cancel,food.biz.rb|func.delay'">
