  ...
  export default {
    ...
    methods: {
      ...
      searchPage() {
        ...
        let _entityType = this.$route.name == 'manage.editors' ? 'COSMETIC_MANAGER' : 'COSMETIC_EMPLOY';
        const formData = {
        ...
        let __entityType = this.$route.name == 'manage.editors' ? 'COSMETIC_MANAGER' : 'COSMETIC_EMPLOY';
