            ...
            <div class="row">
              <div class="row">
                <el-form-item :label="manageRangeText" >
                  <span>{{entity.manageScopeStr ? entity.manageScopeStr : '暂无'}}</span>
                </el-form-item>
              </div>
              <div class="row">
                <el-form-item :label="detailedEngageText" >
                  <span>{{entity.detailedEngageStr ? entity.detailedEngageStr : '暂无'}}</span>
                </el-form-item>
              </div>
            </div>
          </div>
  ...
  import * as common from "api/common";
	export default {
      ...
      getInfo(this.entityId).then(r => {
		...
		methods: {
        back(){
          if(this.$route.query.ratingIndexRisk||this.$route.query.ratingIndexQuantity){//量化等级跳过来
