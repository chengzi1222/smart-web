<template>
  <div>
    <el-table :data="data" class="table-div" ref="table">
...
<script>
  ...
  import { getBackups, removeBack } from 'api/cosmetics/subject';
  export default {
    props: {
      entityType: {
        type: String
    ...
    methods: {
      ...
      pageSearch () {
        ...
        getBackups({'entityType':this.entityType},this.page).then(r => {
