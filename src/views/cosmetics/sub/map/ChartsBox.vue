...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tap: [
          ...
          { type: 'COSMETIC_PRODUCT', name: '化妆品生产', label: '生产主体' },
          { type: 'COSMETIC_MANAGER', name: '化妆品经营', label: '经营主体' },
          { type: 'COSMETIC_EMPLOY', name: '化妆品使用', label: '使用主体' },
        ],
        dit: {
    ...
    mounted() {
      if(this.index=='COSMETIC_MANAGER'){
        this.activeIndex=2;
      }else if(this.index=='COSMETIC_EMPLOY'){
        this.activeIndex=3;
      }else if(this.index=='COSMETIC_PRODUCT'){
        this.activeIndex=1;
      }else{
        this.activeIndex=0;
      }
