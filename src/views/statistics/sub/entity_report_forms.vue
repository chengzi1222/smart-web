<template>
  <div class="user-box">
    <section class="select" style="margin-bottom:20px;">
      ...
      <el-select style="vertical-align: top;" class="w125" v-model="subValue" placeholder="请选择状态" @change="selectChange">
        <el-option v-for="item in subSelect" :key="item.id" :label="item.name" :value="item.code">
        </el-option>
      </el-select>
    ...
    <el-table :data="report" class="table-div" v-loading="loading">
      ...
      <el-table-column show-overflow-tooltip align="center" prop="yzyz" min-width="90" label="有证有照"></el-table-column>
      <el-table-column show-overflow-tooltip align="center" prop="yzwz" min-width="90" label="有照无证"></el-table-column>
      <el-table-column show-overflow-tooltip align="center" prop="wzwz" min-width="90" label="无证无照"></el-table-column>
      <el-table-column show-overflow-tooltip align="center" min-width="90" label="总计">
        <template slot-scope="scope">
          {{scope.row.yzyz + scope.row.yzwz + scope.row.wzwz}}
        </template>
      </el-table-column>
