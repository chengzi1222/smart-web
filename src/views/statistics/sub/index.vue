<template>
  <div class="user-box">
    <div class="page-tilt">
      <b></b>
      <span>统计分析-{{entityTypeLabel}} </span>
    </div>
...
<script>
import statistic from 'views/statistics/sub/sub_statistics';
import report from 'views/statistics/sub/entity_report_forms';
...
export default {
  mounted() {
   ...
   switch (this.entityType){
     case 'product':
        this.entityTypeLabel = '生产主体';
        break;
     case 'circulation':
       this.entityTypeLabel = '流通主体';
       break;
     case 'restaurant':
       this.entityTypeLabel = '餐饮主体';
       break;
   }
  },
  components: {
