<template>
  <!-- <el-form :model="entity" :rules="rules" ref="form" label-width="130px" class="demo-ruleForm labW150 right-info"> -->
      <div class="contentCard">
        ...
        <div class="row red">
          <el-form-item :label="licence.licenceType === 'ONE_CATEGORY' ? '备案编号' : '许可证编号'" prop="licenceNo"
        ...
        <div class="row">
          <el-form-item label="发证日期:"
            ...
            <span v-if="showType === 'info'">{{this.licence.beginDate?this.licence.beginDate:'暂无'}}</span>
          </el-form-item>
          <el-form-item label="有效期至:"
            ...
            <span v-if="showType === 'info'">{{this.licence.endDate?this.licence.endDate:'暂无'}}</span>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    getPlaceholder (category) {
      let placeholder
      if (category === 'ONE_CATEGORY') {
        placeholder = 'Ⅰ类器械生产范围'
      } else if (category === 'TWO_CATEGORY') {
        placeholder = 'Ⅱ类器械生产范围'
      } else if (category === 'THREE_CATEGORY') {
        placeholder = 'Ⅲ类器械生产范围'
      }
      return placeholder
    },
    getLicence(){
