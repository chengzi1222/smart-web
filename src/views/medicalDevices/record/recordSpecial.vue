<template>
  <div v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.8)"
    ...
    <div class="ipt-btn-box" style="margin-left: -20px;" >
      <enum-select v-model="search.entityType" multiple placeholder="主体类型" @change="handleIconClick" enum="com.ybveg.govx.enums.maai.MaaiEntityTypeEnum"></enum-select>
...
<script type="module">
  ...
  import {postRecordPage,getFindSpecialPlanList,getPatrolRecord} from "api/maai/record/recordSpecial";
