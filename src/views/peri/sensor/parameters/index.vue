    ...
    <div class="page-tilt"> 
      ...
      <div class="dataBox">
        <el-table :data="tableData" class="table-div allDown" v-loading="tableLoading" @selection-change="selectionChange">
          ...
          <el-table-column show-overflow-tooltip prop="" label="参数编码" min-width="150">
      ...
      <div v-if="isDialogShow">
        <el-dialog :title="title" :visible.sync="isDialogShow" :append-to-body="true" width="470px">
          <div class="tips" v-if="isTipShow">提示：参数已被使用, 无法编辑<i class="close el-icon-close" @click="isTipShow = false;"></i></div>
          <el-form class="mt30" :model="dialogForm" ref="dialogForm" label-width="100px">
            <el-form-item label="参数编码：">
              <span style="width: 170px">{{dialogForm.index}}</span>
            </el-form-item>
            <el-form-item label="参数名称：">
              <el-input v-model="dialogForm.label" :disabled="hasUsed" style="width: 170px" maxlength="20" placeholder="请输入参数名称"></el-input>
            </el-form-item>
          </el-form>
