      ...
      <div class="mt30 ">
        <div class="mb20 clear_a">
          ...
          <el-button class="w120 fr ml20" type="primary" @click="add('add',null)" v-if='num<=2000'>
            <i style="margin-right: 5px;font-weight: 700;color: #fff;" class="el-icon-plus"></i>添加多选题
          </el-button>
          <el-upload action="" v-if='num<=2000' class="fr" style="display: inline-block" :show-file-list="false"
        ...
        <el-form v-if='isShow' :model="addData" ref="ruleForm" label-width="120px">
          <div style="width:500px;margin:20px auto">
            ...
            <el-form-item label="正确答案：" required>
              <el-checkbox-group v-model="addData.correct">
...
<script>
  ...
  export default {
    ...
    methods: {
      //下载要点表导入模板
      downTableTemplet() {
        location.href = `/api/pxkh/question/template?type=multipleChoice`;
      },
      ...
      add(type, row) {
        ...
        this.addPopTypeTitle = type == 'add' ? '添加多选题' : '编辑多选题';
        this.isShow = true;
        this.addData = {
          id: '',
      ...
      addPop(again) {
        if (this.addData.title == '' || this.addData.choiceA == '' || this.addData.choiceB == '' || this.addData
          .choiceC == '' || this.addData.choiceD == '' || this.addData.correct.length <= 0 || this.addData
          .resolve == '') {
        ...
        data.append('correct', this.addData.correct.sort().toString())
