  ...
  <div>
   ...
   <div class="user-box">
      <div class="mt20 mb20 clear_a">
        ...
        <select-area-grid  class="selectHeight"   placeholder="所属区域" @change="selectAreaGrid"></select-area-grid>
      ...
      <div class="mt20 mb20 clear_a">
        <el-select v-model="queryLimit.hasProcessedEw" :clearable="true" placeholder="培训类型"
          @change="changeSearch">
          <el-option v-for="item in select" :key="item.key" :label="item.name" :value="item.key">
          </el-option>
        </el-select>
        <el-select class="selectHeight" v-model="queryLimit.hasProcessedEw" :clearable="true" placeholder="培训状态"
          @change="changeSearch">
          <el-option v-for="item in select" :key="item.key" :label="item.name" :value="item.key">
          </el-option>
        </el-select>
      ...
      <div class="tabOffTop120">
        <el-table v-loading="loading" @selection-change="handleSelectionChange" element-loading-text="数据正在努力加载中"
          ...
          <el-table-column show-overflow-tooltip prop="buyerName" min-width="120" label="培训标题"></el-table-column>
          <el-table-column show-overflow-tooltip prop="legalPerson" min-width="200" label="培训类型"></el-table-column>
          <el-table-column show-overflow-tooltip prop="tel" min-width="120" label="培训季度"></el-table-column>
          <el-table-column show-overflow-tooltip prop="areaName" min-width="80" label="创建部门"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="总学时"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="课程数"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="培训主体数"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="培训人员数"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="培训状态"></el-table-column>
          <el-table-column show-overflow-tooltip prop="streetAreaName" min-width="80" label="创建日期"></el-table-column>
          <el-table-column label="操作" min-width="150" fixed="right">
            <template slot-scope="scope">
              <a href="javascript:;" class="operate-a">完成</a>
              <a href="javascript:;" class="operate-a">编辑</a>
              <a href="javascript:;" class="operate-a" @click="$router.push({name: 'assess.publicTrainingDetail'});">详情</a>
              <a href="javascript:;" class="operate-a">统计</a>
              <a href="javascript:;" class="operate-a">启用</a>
