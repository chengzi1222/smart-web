        ...
        <ToggleForm title="基础信息">
            <div class="content">
                <el-form-item label="考核名称：" prop="name">
                    <el-input placeholder="请输入考核名称" class="w300" maxlength="15" v-model="baseObj.name"></el-input>
                </el-form-item>
                ...
                <el-form-item label="考核时长：" prop="name">
                    <el-input placeholder="请输入考核时长（分钟）" class="w300" maxlength="15" v-model="baseObj.name"></el-input>
                </el-form-item>
