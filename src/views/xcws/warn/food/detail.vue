    ...
    <div>
        ...
        <div class="user-box">
            <div class="ipt-btn-box" style="justify-content: end;">
                <el-input placeholder="预警商品, 处理人" class="w250 mr20 seekIpt" v-model="tableLimit.keyword"
                ...
                <el-select class="mr20" v-model="tableLimit.handleDept" @change="searchTab" placeholder="请选择处理部门"
                           clearable>
                    <el-option
                            v-for="(value,key) in disposeDept"
                            :key="value"
                            :label="value"
                            :value="key">
                    </el-option>
            ...
            <div class="tabOffTop120">
                <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"
                    ...
                    <el-table-column show-overflow-tooltip prop="pdtName" min-width="190"
                                     label="预警商品"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="stockNo" min-width="120" label="商品批次"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="dlrName" min-width="100" label="配送商"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="purchaseDate" min-width="100"
                                     label="入库日期"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="expiryDate" min-width="100"
                                     label="过期日期"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="ewDate" min-width="100"
                                     label="预警时间"  sortable='custom'></el-table-column>
                    <el-table-column show-overflow-tooltip prop="deduction" min-width="80"
                    ...
                    <el-table-column label="操作" min-width="150" fixed="right">
                        <template slot-scope="scope">
                           <a href="javascript:;" class="operate-a" v-if="scope.row.handlePersonName==''||scope.row.handlePersonName==null"
        ...
        <Dialog :dialogData="dialogData"
                url="/ewcenter/ewFoodExpired/handle"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async searchPage() {
                this.loading = true;
                let result = await guard.getEwFoodExpired(this.tableLimit)
                if (result.status) {
                    this.tableData=[];
