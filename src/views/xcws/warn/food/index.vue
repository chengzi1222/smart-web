        ...
        <div class="user-box">
            ...
            <div class="tabOffTop120">
                <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"
                    ...
                    <el-table-column show-overflow-tooltip prop="ewProcessedNum" min-width="100"
                                     label="已处理预警数"></el-table-column>
                    <el-table-column show-overflow-tooltip prop="ewCurrentNum" min-width="120" label="当前预警数"
                                     sortable='custom'></el-table-column>
                    <!--<el-table-column show-overflow-tooltip prop="credibility" min-width="100" label="可信度（%）"-->
                                     <!--sortable></el-table-column>-->
                    <el-table-column show-overflow-tooltip prop="actualDeduction"  label="扣分数" min-width="120"
                                     sortable='custom'></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async exportList() {
        this.disabled = true;
        guard.getWarningListExport(this.queryLimit).then(r => {
          if (r.status) {
