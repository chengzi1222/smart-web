    ...
    <div>
        ...
        <div class="user-box">
            <div class="ipt-btn-box" style="justify-content: end;">
                ...
                <el-select class="mr20 w200" v-model="tableLimit.handleStatus" @change="searchTab" placeholder="请选择处理状态" clearable>
                    <el-option v-for="item in statusOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
                <el-select class="mr20 w200" v-model="tableLimit.handleType" @change="searchTab" placeholder="请选择处理方式" clearable>
            ...
            <div class="tabOffTop120 mt20">
                <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"
                    ...
                    <el-table-column show-overflow-tooltip prop="originMonth" min-width="190"
                                     label="溯源异常月份"></el-table-column>
                    <el-table-column show-overflow-tooltip  min-width="120"
                                     label="当月溯源率">
                        <template slot-scope="scope">{{scope.row.originRate}} %</template>
                    </el-table-column>
                    <el-table-column show-overflow-tooltip  min-width="100" label="问题描述">
                    ...
                    <el-table-column label="操作" min-width="150" fixed="right">
                        <template slot-scope="scope">
                            <a href="javascript:;" class="operate-a" v-if="scope.row.handleStatus == 0||scope.row.handleStatus == 2"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async searchPage() {
                this.loading = true;
                let result = await guard.getEwOrigin(this.tableLimit)
                if (result.status) {
                    this.tableData = [];
