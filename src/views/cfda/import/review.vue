<template>
  <div class="user-box">
    <div class="ipt-btn-box clear_a">
      <el-input placeholder="许可证编号、主体名称、社会信用代码" class="w250 seekIpt" v-model="searchMap.keyword" @keyup.enter.native="">
        <i slot="suffix" class="el-input__icon el-icon-search" @click="pageSearch"></i>
      </el-input>
      <enum-select class="selectHeight" v-model="searchMap.manageState" placeholder="经营状态" enum="com.ybveg.govx.enums.ManageStateEnum"
    ...
    <div class="tabOffTop120">
      <el-table @sort-change="sortChange" :border="true" :resizable="true" :data="tableData" @selection-change="selectChange" class="table-div">
        ...
        <el-table-column show-overflow-tooltip prop="entityTypeStr" min-width="160" label="*主体类型"></el-table-column>
        ...
        <el-table-column show-overflow-tooltip prop="deptName" min-width="140" label="所属部门"></el-table-column>
...
<script>
  ...
  import { page, review, del } from 'api/cfda/import'
      ...
      reviews() {
        this.$confirm('是否确认审核？', '提示', {
          ...
          if (this.selectRow.length === 1) {
            this.review(this.selectRow[0].id)
          } else {
            let ids = new Array()
