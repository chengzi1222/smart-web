            ...
            <div v-if="cfda.pedlarType == 'FIXE'">
              ...
              <div class="row">
                <el-form-item label="经营时间段:" prop="placeTime">
                  <el-time-select class="w150" :editable="false" :picker-options="{start: '00:00',step: '00:30',end: '23:30'}" v-model="cfda.placeTimeBegin" placeholder="请选择经营时间"></el-time-select>
                  到
                  <el-time-select :editable="false" class="w150" v-model="cfda.placeTimeEnd" :picker-options="{start: '00:00',step: '00:30',end: '23:30'}" placeholder="请选择经营时间"></el-time-select>
                </el-form-item>
              </div>
            </div>
...
<script>
  ...
  import {addAutoSave,addBackup,getGrid,getInfoAssi,getSoEmp,getSyj,removeFile} from "api/cfda/add.js";
