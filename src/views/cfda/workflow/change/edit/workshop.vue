...
import {  addCfda, addAutoSave, getSyj, getGrid, getSoEmp, getInfoAssi,  getProd, getProdByList, getProdTypes, removeFile, getEntityByCredit} from "api/cfda/add.js";
import SearchTap from "components/SearchTap.vue";
import { floatValid, idNoValid, phoneValid, checkSocialCreditCode } from 'utils/validate'
import { updateReviewInfo } from 'api/cfda/bizWorkflow.js'
...
export default {
  ...
  async mounted() {
    ...
    getCfda(this.entityId).then(async (r) => {
      ...
      //        r.data.detailedEngage = detailedEngages;
