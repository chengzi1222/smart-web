          ...
          <div class="content">
            ...
            <div class="row">
              <el-form-item label="三小备案时间:" prop="recordBegin">
                <el-date-picker class="w140" v-model="cfda.recordBegin" :editable="false" :default-value="cfda.recordBegin" type="date" placeholder="选择日期范围">
                </el-date-picker>
              </el-form-item>
            </div>
...
import { addCfda, addAutoSave, getSyj, getGrid, getSoEmp, getInfoAssi, removeFile, getEntityByCredit} from "api/cfda/add.js";
