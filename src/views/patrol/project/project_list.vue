<template>
  <div class="user-box">
    ...
    <div class="ipt-btn-box">
      <div>
        <el-input placeholder="请输入巡查项目名称" v-model="page.keywords" class="w250 seekIpt" @keyup.enter.native="handleIconClick">
          <i slot="suffix" class="el-input__icon el-icon-search" @click="handleIconClick"></i>
        </el-input>
      </div>

      <div>
        <el-button class="selectHeight" type="primary" @click="showAdd">添加巡查项
        </el-button>
      </div>
      ...
      <transition name="dialog-fade">
        <popupBody class="popup-body" v-if="isShow">
          ...
          <el-form :model="patrolProject" :rules="rules" ref="patrolProject" label-width="100px" class="demo-ruleForm">
    ...
    <el-table :data="tableData" class="table-div">
      <el-table-column prop="name" label="巡查项目名称"  min-width="130" ></el-table-column>
      <el-table-column prop="no" label="巡查项编号"  min-width="130" ></el-table-column>
      <el-table-column prop="projectTotalScore" label="项目总分值"  min-width="100" ></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goBack() {
        this.$router.push({ name: 'patrolContextList', query: { patrolTableId: this.patrolTableId } });
      },
