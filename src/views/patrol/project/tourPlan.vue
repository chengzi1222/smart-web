  ...
  <div class="user-box" ref="loadingDiv">
    ...
    <toggle-form title="巡查频次配置" v-if="daily.type == 'INTELLIGENT'">
      <div class="form-item mt20">主体类型:
        <el-button class="ml20" :type="entityType == 'PRODUCT' ? 'primary':''" @click="checkType('PRODUCT')">生产主体</el-button>
        <el-button :type="entityType == 'RESTAURANT' ? 'primary':''" @click="checkType('RESTAURANT')">餐饮主体</el-button>
        <el-button :type="entityType == 'CIRCULATION' ? 'primary':''" @click="checkType('CIRCULATION')">流通主体</el-button>
        <el-button :type="entityType == 'CFDA' ? 'primary':''" @click="checkType('CFDA')">三小主体</el-button>
      </div>
        ...
        <el-table style="width: 100%;" :data="this.daily.entityConfig[this.entityType]" class="table-div">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <div v-else>
                <a style="cursor: pointer" v-if="!scope.row.edit" @click="configEdit(scope)">编辑</a>
    ...
    <div class="foot-btn" style="z-index:998">
      <div>
        <el-button v-if="!edit" @click="editCik()" class="cdit">编辑</el-button>
...
<script  type="module">
  ...
  import * as plan from 'api/patrol/dailyPlan'
