          ...
          <div style="width:630px;margin:30px auto 0;">
            <el-form :model="patrolContext" :rules="rules" ref="patrolContext" label-width="100px"
              ...
              <el-row>
                <el-col :span="10">
                  <el-form-item label="编号:" prop="no">
                    <el-input type="text" placeholder="请输入分类编号" maxlength="3" class="w150" @keyup.native="numberCheck"
              ...
              <el-form-item label="快捷巡查:" prop="quick">
                <el-input type="textarea" placeholder="可配置巡查时的快速录入项，每次换行为一个录入项" class="w440" maxlength="500"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goProject() {
        this.$router.push({name: "patrolProjectList", query: {"patrolTableId": this.patrolTableId}})
      },

      goBack() {
        this.$router.push({name: 'patrolTableList'});
      },
