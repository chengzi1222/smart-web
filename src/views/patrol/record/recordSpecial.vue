<template>
  ...
  element-loading-background="rgba(255, 255, 255, 0.8)" class="user-box">
    ...
    <div class="tabOffTop170">
      <el-table :data="tableData" class="table-div"  :border="true" :resizable="true"  @sort-change="handleSortChange" :key="maxheight" :class="shadowShow?'shadowNo':''">
        ...
        <el-table-column show-overflow-tooltip prop="patrolRecordNo"  min-width="110" label="巡查记录编号"></el-table-column>
        <el-table-column show-overflow-tooltip prop="deptName" label="辖区机构" min-width="110"></el-table-column>
        <el-table-column show-overflow-tooltip prop="planName" min-width="100" label="巡查计划"></el-table-column>
        <el-table-column show-overflow-tooltip prop="entityTypeLabel" min-width="90" label="主体类型"></el-table-column>
        <el-table-column show-overflow-tooltip prop="superviseName" min-width="80" label="监管人员"></el-table-column>
        <el-table-column show-overflow-tooltip prop="messName" min-width="70" label="信息员"></el-table-column>
        <el-table-column show-overflow-tooltip prop="result" min-width="70" label="巡查结果"></el-table-column>
        <el-table-column show-overflow-tooltip resizable min-width="70" label="问题项/巡查项">
          <template slot-scope="data">
            <span>{{data.row.quesTotal}}/{{data.row.allTotal}}</span>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip prop="treat" min-width="70" label="处理方式"></el-table-column>
        <el-table-column show-overflow-tooltip prop="doDeptName"  min-width="100" label="检查部门"></el-table-column>
        <el-table-column show-overflow-tooltip prop="patrolTime" sortable="custom" min-width="70" label="巡查日期"></el-table-column>
...
<script>
  import {findListByAreaCode, findSpecialPage} from "api/patrol/record/record";
  ...
  export default {
    ...
    methods: {
      ...
      async printRecord(id, isPreview){
        this.loading = true;
        await this.printInitData(id, "SPECIAL");
