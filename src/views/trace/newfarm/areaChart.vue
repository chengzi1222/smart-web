    ...
    <div class="main_content">
      ...
      <section class="item1 clear_a">
        <div class="left">
          ...
          <div class="floatR ">
            ...
            <div style="width:100%;height:88%;" id="FAbar1">
      ...
      <section class="item2">
        ...
        <div class="info">
          ...
          <div class="floatR">
            <div style="width:100%;height:100%;" id="FAusearea">
              <div class="partlyLoading">
                <div>拼命加载中...</div>
              </div>
            </div>
      ...
      <section class="item3 boxSB">
        <div style="width:100%;height:100%;" id="FAhis">
          <div class="partlyLoading">
            <div>拼命加载中...</div>
          </div>
        </div>
      ...
      <section class="item7" v-show="false">
        ...
        <el-table :data="dataPage3" class="textC table-div pointerTab" @row-click="rowclick">
          <el-table-column show-overflow-tooltip prop="area" min-width="180" label="街道" align="center">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="marketNum" min-width="100" label="批发市场数量" align="center">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="current" min-width="100" label="当月溯源使用率" align="center">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="lastMonth" min-width="100" label="上月溯源使用率" align="center">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="currentNum" min-width="100" label="当月检测批次" align="center">
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="lastMonthNum" min-width="100" label="上月检测批次" align="center">
          </el-table-column>
        </el-table>
      </section>
    </div>
    ...
    <div v-if="rankList" class="rankBox">
      <div class="rank">
        ...
        <p v-for="(item,idnex) in rankData" :class="item.areaId == areaId_ ? 'theIs': '' " :key="idnex">
          ...
          <span style="width: 190px;text-align: center;">{{ item.rate.toFixed(2) }}%</span>
        </p>
      </div>
    </div>
  </div>
...
<script>
  ...
  import { getNodeBussCount, getAreaSNode, getAreaTraceTop, getAreaSTraceVo, getAreaSTraceVoHistory,
            getRealTimeTrace, getRiskVariety, getMonthDetec, getRealDetec, getAreaTraceRank, getAreaOwnRank } from 'api/trace/newfarm';
  ...
  export default {
    ...
    methods: {
      ...
      getAreaSNode() { //各个区域下的节点个数统计
        ...
        getAreaSNode(params).then(r => {
          if (r.status) {
            ...
            bar_echart(this.bar1Data, "FAbar1", this.$router);
          }
        })
      },
      ...
      getAreaSTraceVo() { //区域溯源率
        ...
        getAreaSTraceVo(params).then(r => {
          if (r.status) {
            ...
            bar_echart(this.useData, "FAusearea", this.$router);
          }
        })
      }, 
      getAreaSTraceVoHistory() { //区域历史12个月溯源率
        ...
        getAreaSTraceVoHistory(params).then(r => {
          if (r.status) {
            ...
            bar_echart(this.hisData, "FAhis", this.$router);
          }
        })
      }, 
      ...
      //排名导出
      down() {
        this.derive = encodeURI(`${config.newExport}/trace/supervise/area/trace/rank/export?areaId=${this.areaId_}&date=${this.seldate}&nodeType=FARMER`);
      },
      use_() {
