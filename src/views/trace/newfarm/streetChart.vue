    ...
    <div class="main_content">
      ...
      <section class="item1 clear_a">
        <div class="left">
          ...
          <div class="floatR ">
            ...
            <div style="width:100%;height:88%;" id="FSbar1">
      ...
      <section class="item2">
        ...
        <div class="info">
          ...
          <div class="floatR">
            <div style="width:100%;height:100%;" id="FSusearea">
              <div class="partlyLoading">
                <div>拼命加载中...</div>
              </div>
            </div>
      ...
      <section class="item3 boxSB">
        <div style="width:100%;height:100%;" id="FShis">
          <div class="partlyLoading">
            <div>拼命加载中...</div>
          </div>
        </div>
...
<script>
  ...
  import {
    getNodeBussCount, getAreaSNode, getAreaTraceTop, getAreaSTraceVo, getAreaSTraceVoHistory,
    getRealTimeTrace, getRiskVariety, getMonthDetec, getRealDetec, getAreaTraceRank, getAreaOwnRank
  } from 'api/trace/newfarm';
  ...
  export default {
    ...
    methods: {
      getNodeBussCount() { //节点和经营者总数
        ...
        getNodeBussCount(params).then(r => {
          if (r.status) {
            this.sourceNunber = r.data.bussNum;
            this.totalBiz = r.data.nodeNum;
          }
        })
      },
      getAreaSNode() { //各个区域下的节点个数统计
        ...
        getAreaSNode(params).then(r => {
          if (r.status) {
            ...
            bar_echart(this.bar1Data, "FSbar1", this.$router);
          }
        })
      },
        ...
        getAreaSTraceVo(params).then(r => {
          if (r.status) {
            ...
            for (let i = 0; i < r.data.childArea.length; i++) {
              if(r.data.childArea[i].areaName.length>8){
                useareas_.push(r.data.childArea[i].areaName.slice(0,8)+'...');
              }else {
            ...
            bar_echart(this.useData, "FSusearea", this.$router);
          }
        })
      }, 
      ...
      getAreaSTraceVoHistory() { //区域历史12个月溯源率
        ...
        getAreaSTraceVoHistory(params).then(r => {
          if (r.status) {
            ...
            bar_echart(this.hisData, "FShis", this.$router);
          }
        })
      }, 
    ...
    mounted: function () {
      ...
      if (this.$route.query.areaid) {
        ...
        if (!this._isDestroyed) {
          if(this.$store.state.common.user.areaCode>10){
            this.areaId_ = this.$store.state.common.user.areaCode.slice(0,10);
          } else {
