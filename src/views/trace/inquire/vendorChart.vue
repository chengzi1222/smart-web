<template>
    <div class="area">
        <div class="page-tilt">
            <b></b><span>批发市场溯源监管{{ titl[0]=="-" ? titl :"-"+titl }}</span><Back></Back>
        </div>
           ...
           <section class="item1 clear_a">
                <div class="left boxSB">
                    ...
                    <div class="clear_a panel">
                        <ul class="clear_a fs14" v-if="information">
                           <li><span class="leftName">批发市场名称：</span><span class="rightText" :title="information.nodeName">{{information.nodeName}}</span></li>
            ...
            <section class="item7">
                ...
                <div class="filtrate mb20">
                    ...
                    <el-input style="margin-left: 20px;" placeholder="商品名"  class="w260 seekIpt"  v-model="subName" @keyup.enter.native ="getBizDetail">
                        <i slot="suffix" class="el-input__icon el-icon-search" @click="getBizDetail"></i>
                    </el-input>
                </div>
                <div style="position: relative;">
                    <div v-if="lodings" style="position: absolute;top: 0;left: 0;bottom: 0;right: 0;z-index: 99;text-align: center">
                        <div class="partlyLoading loading"><div></div></div>
                    </div>
                    <el-table :data="dataPage3" class="textC table-div pointerTab">
                        ...
                        <el-table-column show-overflow-tooltip prop="detecType" min-width="120" label="检测类型"  align="center" ></el-table-column>
                        <el-table-column show-overflow-tooltip prop="displayVal" min-width="100" label="检测值"  align="center" ></el-table-column>
                        <el-table-column show-overflow-tooltip prop="detecResult" min-width="100" label="检测结果"  align="center" ></el-table-column>
                    </el-table>
...
export default {
    ...
    methods: {
        ...
        getBizRateHistory(){
            ...
            plan.getBizRateHistory(obj).then(d => {
                let hisData=[];
                let hisRate=[];
                for(let item in d){
