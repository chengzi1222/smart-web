...
<script>
  ...
  export default {
    methods: {
      ...
      //排名导出
      down() {
        this.derive = encodeURI(`${config.newExport}/trace/supervise/area/trace/rank/export?areaId=${this.$store.state.common.user.areaCode}&date=${this.seldate}&nodeType=WHOLESALE`);
      },
      use_() {
