<template>
  <div class="user-box">
    <div class="page-tilt">
      <b></b>
      <span>新批发市场溯源监管 - 综合查询分析</span><Back></Back>
    </div>
    <ul class="tab-box">
    ...
    <div style="position: relative;">
      ...
      <el-table :data="tableData" class="table-div" :key="mess.choose">
        ...
        <el-table-column show-overflow-tooltip prop="goodsName" label="溯源商品" v-if="mess.key == 0" align="left">
        </el-table-column>
...
<script>
  import {
    getTraceDetailPaging, getTraceLowAreaPaging, getTraceLowMarketPaging, getTraceLowBussPaging,
    getNodeList, getChildrenAreaFind
