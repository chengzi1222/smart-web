      ...
      <div class="content" style="width:870px;">
        <div class="row">
          <el-form-item label="所属食药所:" prop="syj">
            <el-select @change="syjChange" v-model="entity.syj" class="w200" placeholder="请选择所属食药所">
          ...
          <el-form-item label="所在网格:" prop="grid">
            <el-select @change="gridSelectChange" @blur="validated" class="w200" v-model="entity.grid" placeholder="请选择所属网格">
        ...
        <div class="row">
          <el-form-item label="监管人员:" prop="so">
            <el-select @change="soChange" v-model="entity.so"  class="w200" placeholder="请选择监管人员">
        ...
        <div class="row">
          <el-form-item label="网格信息员:" prop="infoAssi">
            <el-select @change="infoAssiChange" v-model="entity.infoAssi" class="w200"  placeholder="请选择网格信息员">
