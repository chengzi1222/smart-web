      ...
      <div class="content">
        ...
        <div class="row">
          <el-form-item label="许可备案号:" class="" prop="backupNo">
            <el-input @blur="validated" class="w200" v-model="entity.backupNo" :maxlength="32" placeholder="请输入许可备案号"></el-input>
            <span style="color: #A2AAB6;font-size:12px;margin-left:10px;float: right;">(必填)</span>
          </el-form-item>
        ...
        <div class="row">
          <el-form-item label="有效期:">
            <el-date-picker class="w200" @change="validated" v-model="entity.recordBegin" :editable="false" :picker-options="pickerOptions0"
              placeholder="选择日期"></el-date-picker>
            -
            <el-date-picker class="w200" @change="validated" v-model="entity.recordEnd" :editable="false" :picker-options="pickerOptions1"
              placeholder="选择日期"></el-date-picker>
          </el-form-item>
        </div>
      </div>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          backupNo: [
            { required: true, message: "请输入许可备案号", trigger: "change" }
          ]
        }
      };
    },
