<template>
  <div class="user-box">
    <div class="ipt-btn-box clear_a">
      <el-input placeholder="社会信用代码、许可证编号、主体名称" class="w250 seekIpt" v-model="searchMap.keysWork" @keyup.enter.native="">
        <i slot="suffix" class="el-input__icon el-icon-search" @click="pageSearch"></i>
      </el-input>
      <enum-select class="selectHeight" multiple v-model="searchMap.backupState" placeholder="许可证状态" enum="com.ybveg.govx.enums.LicenceStateEnum"
    ...
    <div class="tabOffTop120">
      <el-table @sort-change="sortChange" :border="true" :resizable="true" :data="tableData" @selection-change="selectChange" class="table-div">
        ...
        <el-table-column show-overflow-tooltip prop="backupNo" min-width="120" label="*许可证编号"></el-table-column>
        <el-table-column show-overflow-tooltip prop="backupState" min-width="120" label="*许可证状态"></el-table-column>
...
<script>
  ...
  import { page, review, del } from 'api/medi/subject/import'
