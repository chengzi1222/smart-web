                    ...
                    <div class="content" v-if="basicInfoData">
                        <div class="row">
                            <el-form-item label="主体名:" prop="">
                                ...
                                <a href="javascript:;" @click="ifType">进入该主体档案</a>
                            </el-form-item>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <el-form-item label="信息员:" prop="" v-if="$store.getters.user.areaCode.length > 6">
                ...
                <toggle-form title="巡查项（仅显示本次检查的巡查项）">
                    <div class="mT35" v-if="patrolData">
                        ...
                        <el-table :key="index" v-for="(item,index) in patrolData" :class="index==0?'firsTeit':''" :data="item.content" :span-method="objectSpanMethod" border class="table-div brN">
                          ...
                          <el-table-column show-overflow-tooltip prop="qualStr" label="是否检查通过" width="80">
                            <template slot-scope="scope">
  ...
  export default {
    ...
    methods:{
        ...
        ifType(){
          ...
          this.$router.push({path: '/medi/subject/' + this.basicInfoData.entityType.toLowerCase() + '/detail',
            query: {
