<template>
  <div v-loading="loading" element-loading-text="拼命加载中"
    ...
    <div class="tabOffTop170">
      <el-table :data="tableData" class="table-div"   :border="true" :resizable="true"  :class="shadowShow?'shadowNo':''"
                @sort-change="handleSortChange" :key="maxheight" >
        <el-table-column type="index" min-width="50" label="序号"></el-table-column>
        <el-table-column show-overflow-tooltip prop="entityName" min-width="120"
        ...
        <el-table-column show-overflow-tooltip prop="entityTypeExtLabel" min-width="70"
        ...
        <el-table-column show-overflow-tooltip prop="treat" min-width="70"
                         label="处理方式"></el-table-column>
        <el-table-column show-overflow-tooltip prop="doDeptName"  min-width="110"
                         label="检查部门"></el-table-column>
        <el-table-column show-overflow-tooltip prop="patrolTime" sortable="custom" min-width="90"
...
<script>
  import {findDailyPage} from "api/medi/patrol/record";
  ...
  export default {
    ...
    methods: {
      ...
      add() {
        this.$router.push({"name": "mediPatrolRecordAdd"});
      },
      //页面查询
      async getPage() {
