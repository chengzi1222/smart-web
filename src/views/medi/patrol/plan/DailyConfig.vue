  ...
  <div class="user-box" ref="loadingDiv">
    ...
    <toggle-form title="巡查频次配置" v-if="daily.type == 'INTELLIGENT'">
      <div class="form-item mt20">主体类型:
        <el-button class="ml20" :type="entityType == 'MEDICINE_MANAGER' ? 'primary':''" @click="checkType('MEDICINE_MANAGER')">经营主体</el-button>
        <el-button :type="entityType == 'MEDICINE_EMPLOY' ? 'primary':''" @click="checkType('MEDICINE_EMPLOY')">使用主体</el-button>
      </div>
