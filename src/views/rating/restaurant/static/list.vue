        ...
        <div class="user-box">
            ...
            <div class="tabOffTop120">
                <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"
                    ...
                    <el-table-column show-overflow-tooltip min-width="50" label="静态分数">
                        <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            uploadConfig(file, callback) {
                ...
                formdata.append('scoreType', 'STATIC');
            ...
            downTableTemplet() {
                location.href = `/api/food/djpd/record/template?scoreType=STATIC`;
            },
            ...
            async exportList() {
                ...
                if (result.status) {
                    downloadFile(result.data, '静态评分导出')
                } else {
