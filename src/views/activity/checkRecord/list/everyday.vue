  ...
  <div v-loading="loading" element-loading-text="拼命加载中"
    ...
    <div class="user-box">
      <div class="ipt-btn-box" style="justify-content: end;">
        ...
        <el-select class="selectHeight" v-model="sel.patrolDatePc" clearable placeholder="检查日期" @change="searchTab">
      ...
      <div class="tabOffTop50">
        <el-table :data="tableData" :border="true" :resizable="true" @sort-change="sortChange" class="table-div">
          ...
          <el-table-column show-overflow-tooltip prop="entity_name" min-width="100" label="接待单位名称"></el-table-column>
          <el-table-column show-overflow-tooltip prop="patrol_date" min-width="80" label="检查日期"></el-table-column>
          ...
          <el-table-column show-overflow-tooltip prop="rectify_state_name" min-width="60"
                           label="整改情况"></el-table-column>
          <el-table-column show-overflow-tooltip prop="rectify_remark" min-width="90" label="备注"></el-table-column>
          <el-table-column show-overflow-tooltip prop="patrol_time" min-width="80" label="检查时间"
          ...
          <el-table-column label="操作" min-width="150">
            <template slot-scope="scope">
              ...
              <a href="javascript:" v-if="scope.row.rectify_state == 'TODO'" class="operate-a"
                 @click="openRectify(scope.row)">整改</a>
            </template>
          </el-table-column>
        </el-table>
            ...
            <div class="row">
              <el-form-item label="整改备注" prop="">
                <el-input
                  ...
                  :rows="5"
                  :maxlength="200"
                  placeholder="请输入整改备注,选填"
                  v-model="dto.rectifyRemark">
                </el-input>
    ...
    <!-- 打印组件 -->
    <tablePrint ref="tablePrint"
                 :resultData="infoData"
                 :patrolType="'重大活动保障每日检查'"
    ></tablePrint>
  </div>
</template>
...
<script>
  ...
  import tablePrint from '../detail/everydatTablePrint.vue'
  import { doPrintRecord } from 'utils/print/doPrint.js'

  export default {
    mounted() {
      everyday.webInit().then(r => {
        ...
        everyday.dateSelect(this.taskId).then(r => {
    ...
    methods: {
      ...
      async printInitData(id) {
        this.qrcodeId = id
        await everyday.detail({id: id}).then(r => {
      ...
      chose() {
        ...
        everyday.rectify(formData).then(r => {
          if (r.status) {
      ...
      async searchPage() {
        ...
        //  params.append('taskId', '0b1932695b0a4a349975792013616a51');
        ...
        params.append('patrolDatePc', this.sel.patrolDatePc);
        everyday.list(params).then(r => {
          this.loading = false;
      ...
      // 查看详情
      detail(d) {
        this.$router.push({name: "record.everydayDetail", query: {id: d.id}});
      }
    },
    components: {
      YbPopup,
