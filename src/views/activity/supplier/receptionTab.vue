    ...
    <div class="popup-box" v-if="popup">
      <div class="popup-body content">
        ...
        <el-form label-width="110px" class="demo-ruleForm ml35">
          <div class="row">
            <el-form-item label="接待单位名称：" prop="">
            ...
            <el-form-item label="供应商账号：" prop="">
              <el-input v-if="popupTit == 'add' || popupTit == 'redact'" v-model="rulesForm.userName" class="w162" :maxlength="16" placeholder="请输入供应商账户"></el-input>
              <span v-if="popupTit == 'add' || popupTit == 'redact'" class="required">（必填）</span>
          ...
          <div class="row">
            ...
            <el-form-item label="联系方式：" prop="">
              <el-input v-if="popupTit == 'add' || popupTit == 'redact'" v-model="rulesForm.mobile" class="w162" placeholder="请输入联系方式"></el-input>
  ...
  export default {
    ...
    methods: {
      ...
      getPageData() {
        ...
        params.append('entityType', 'RECEPTION')
      ...
      add() {
        ...
        if (this.rulesForm.userName.length < 3) {
          this.$message.error('接待商账号不能长度小于3位')
          this.butClick = true;
          return false
        }
      ...
      update() {
        ...
        if (this.rulesForm.userName.length < 3) {
          this.$message.error('接待商账号长度不能小于3位')
          this.butClick = true;
          return false
        }
        if ((this.rulesForm.lng + '').split('.').length == 2 && (this.rulesForm.lng + '').split('.')[1].length >= 7) {
