...
<div>
  ...
  <div class="user-box">
    <div class="ipt-btn-box" style="justify-content: end;">
      <el-input placeholder="学校名称" class="w250 seekIpt" v-model="condition.keyword" @keyup.enter.native="handleIconClick">
        <i slot="suffix" class="el-input__icon el-icon-search" @click="handleIconClick"></i>
      </el-input>

      <enum-select class="selectHeight" v-model="condition.buyerType" placeholder="学校类型" enum="com.ybveg.govx.enums.sub.RestaurantSuperviseTypeEnum" @change="searchTab"></enum-select>
    ...
    <div class="tabOffTop120">
      <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"  :data="tableData" class="table-div" :class="shadowShow?'shadowNo':''" >
          ...
          <div class="popBody">
               ...
               <div class="clear_a imgBoxPop">
                ...
                <ul class="clear_a imgBoxPop">
                  <img v-if="entity.healthInfo.length==0" :src="require('assets/img/schoolTrace/noHealth.png')" alt="">
