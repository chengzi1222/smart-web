        ...
        <div class="row">
          ...
          <div class="row">
            <el-form-item label="监管类型:">
              <enum-select @change="validated" class="w200" v-model="entity.superviseType" enum="com.ybveg.govx.enums.sub.RestaurantSuperviseTypeEnum" placeholder="请选择监管类型"></enum-select>
            </el-form-item>

            <el-form-item label="网络经营:" class="floatR" style="margin-right: 110px">
              <dict-select @change="validated" class="w200" v-model="entity.networkOperation" dict="RB_NO" placeholder="请选择网络经营类型"></dict-select>
            </el-form-item>
          </div>
          ...
          <div class="row">
            ...
            <el-form-item label="主体业态:">
              <dict-select @change="validated" class="w200" v-model="entity.subType" dict="RB_SUB" placeholder="请选择主体业态"></dict-select>
            </el-form-item>
          </div>
    ...
    data() {
      return {
        ...
        entity: {
          ...
          operPro: [], //经营项目
          operProMore: [],
          superviseType: null, // 监管类型
          networkOperation: null // 网络经营
        },
        //验证
        rules: {
          spaceArea: [
