    ...
    <div v-if="!isDrafts">
      ...
      <div class="main-body no-star">
        ...
        <div class="form-item">主体类型:
          <el-button @click="btnClick(item,index)" class="router-btn" :class="{'active':index==currentBtn}" v-for="(item,index) in btns"
            :key="index">
            {{item.title}}
          </el-button>
        </div>
        ...
        <div class="right-info">
          ...
          <!-- 基础信息 -->
          <base-component @getData="getData" :entityType="form.entityType" :handleState="handleState" :initData="form" :key="currentBtn"
            :natureType="form.natureType" ref="prodcut" @validated="validated"></base-component>
