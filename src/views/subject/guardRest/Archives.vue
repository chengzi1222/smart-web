  ...
  <div>
    ...
    <div class="user-box">
      <div class="ipt-btn-box" style="justify-content: end;">
        <el-input placeholder="主体名称、营业执照、许可证号" class="w250 seekIpt" v-model="condition.keyword"
          @keyup.enter.native="handleIconClick">
          <i slot="suffix" class="el-input__icon el-icon-search" @click="handleIconClick"></i>
        </el-input>

        <enum-select class="selectHeight" v-model="condition.buyerType" placeholder="主体类型"
      ...
      <div class="tabOffTop120">
        <el-table v-loading="loading" element-loading-text="数据正在努力加载中" :border="true" :resizable="true"
          ...
          <el-table-column show-overflow-tooltip prop="" min-width="120" label="主体类型">
          ...
          <el-table-column show-overflow-tooltip prop="tel" min-width="100" label="联系方式"></el-table-column>
          <el-table-column show-overflow-tooltip prop="address" min-width="100" label="地址"></el-table-column>
          ...
          <el-table-column label="操作" min-width="150" fixed="right">
            <template slot-scope="scope">
              ...
              <router-link v-if="XCWSOpenSecret!=''&& XCWSOpenSecret!=null"
                ...
                target="_blank">
                <span class="operate-a">食安公示</span>
              </router-link>
      ...
      <!-- 二维码 -->
      <el-dialog class="qrCode-dialog" :visible.sync="qrCodeShow" title="放心食安" :append-to-body="true" width="300px">
        <p>请使用微信扫描二维码</p>
