<template>
  <div class="bigbox">
    ...
    <toggle-form title="要点表核查内容信息" v-if="form.id !== ''">
      <div class="mt20 mb20">
        <el-button class="w130 mr20" type="primary" @click="dialog.show = true">添加核查内容</el-button>
        <el-button class="w130 mr20" @click="go('xchc.pointManage.setting',form.id)">配置核查项目</el-button>
        <!-- <el-button class="w100 mr20">导入</el-button>
...
export default {
  ...
  methods: {
    ...
    async getBaseData(){
     ...
     this.form.businessType = result.data.businessType
     this.form.description = result.data.description
     this.settingForm.cruxNum = result.data.cruxNum+''
     this.settingForm.importantNum = result.data.importantNum+''
     this.settingForm.generalImportNum = result.data.generalImportNum+''
