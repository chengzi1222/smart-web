...
import Type from '../../../one/type'
import Grow from '../../../one/grow'
import Subject from '../../../one/subject'
  export default {
    components: {
        mapEcharts,
        Type,
...
.bottom{
    ...
    >li{
        ...
        border:1px solid rgba(53,122,162,1);
        width:770px;
