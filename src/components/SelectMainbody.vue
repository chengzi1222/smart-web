...
//      return false;
    ...
    methods:{
      ...
      refresh(){
        ...
        if(this.entryType === 'randomEntity') {
          this.apiFn(this.taskGroupId, this.limit,this.currentPage,Object.assign({},{'search':this.search,'type':this.select},this.params)).then(r =>{
            let data = r.data;
            this.total = data.total;
            this.tableData = [...data.list];
          })
        } else if (this.entryType === 'mediPatrol') {
          this.apiFn(this.limit, this.currentPage,
            Object.assign({}, {'search': this.search, 'entityTypes': this.select},
              this.params)).then(r => {
            let data = r.data;
            this.total = data.total;
            this.tableData = [...data.list];
          })
        } else if(this.entryType === '') {
          this.apiFn(Object.assign({},{'search':this.search,'entityTypes':this.select},this.params), this.limit,this.currentPage).then(r =>{
            let data = r.data;
            this.total = data.total;
            this.tableData = [...data.list];
          })
